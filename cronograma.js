...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function carregarMaterias(dia) {
        ...
        // Cria um item para cada matéria
...
const primeiroBotao = document.querySelector('.btn-dia');

primeiroBotao.classList.add('ativo');

const primeiroDia = primeiroBotao.getAttribute('data-dia');

carregarMaterias(primeiroDia);
